...
impl Attribute {
    ...
    pub fn pretty(&self) -> String {
        match self {
            Self::Dimmer => format!("Dimmer"),

            Self::Pan => format!("Pan"),
            Self::Tilt => format!("Tilt"),
            Self::PanRotate => format!("Pan Rotate"),
            Self::TiltRotate => format!("Tilt Rotate"),
            Self::PositionEffect => format!("Position Effect"),
            Self::PositionEffectRate => format!("Position Effect Rate"),
            Self::PositionEffectFade => format!("Position Effect Fade"),
            Self::XyzX => format!("X"),
            Self::XyzY => format!("Y"),
            Self::XyzZ => format!("Z"),
            Self::RotX => format!("Rotation X"),
            Self::RotY => format!("Rotation Y"),
            Self::RotZ => format!("Rotation Z"),
            Self::ScaleX => format!("Scale X"),
            Self::ScaleY => format!("Scale Y"),
            Self::ScaleZ => format!("Scale Z"),
            Self::ScaleXYZ => format!("Scale XYZ"),
            ...
            Self::PlayMode => format!("Play Mode"),
            Self::PlayBegin => format!("Play Begin"),
            Self::PlayEnd => format!("Play End"),
            Self::PlaySpeed => format!("Play Speed"),
            ...
            Self::ColorAddR => format!("Red"),
            Self::ColorAddG => format!("Green"),
            Self::ColorAddB => format!("Blue"),
            Self::ColorAddC => format!("Cyan"),
            Self::ColorAddM => format!("Magenta"),
            Self::ColorAddY => format!("Yellow"),
            Self::ColorAddRY => format!("Red-Yellow"),
            Self::ColorAddGY => format!("Green-Yellow"),
            Self::ColorAddGC => format!("Green-Cyan"),
            Self::ColorAddBC => format!("Blue-Cyan"),
            Self::ColorAddBM => format!("Blue-Magenta"),
            Self::ColorAddRM => format!("Red-Magenta"),
            Self::ColorAddW => format!("White"),
            Self::ColorAddWW => format!("Warm White"),
            Self::ColorAddCW => format!("Cool White"),
            Self::ColorAddUV => format!("UV"),
            Self::ColorSubR => format!("Red-"),
            Self::ColorSubG => format!("Green-"),
            Self::ColorSubB => format!("Blue-"),
            Self::ColorSubC => format!("Cyan-"),
            Self::ColorSubM => format!("Magenta-"),
            Self::ColorSubY => format!("Yellow-"),
            Self::ColorMacro(n) => format!("Color Macro {n}"),
            Self::ColorMacroRate(n) => format!("Color Macro Rate {n}"),
            Self::Cto => format!("CTO"),
            Self::Ctc => format!("CTC"),
            Self::Ctb => format!("CTB"),
            Self::Tint => format!("Tint"),
            Self::HsbHue => format!("HSB Hue"),
            Self::HsbSaturation => format!("HSB Saturation"),
            Self::HsbBrightness => format!("HSB Brightness"),
            Self::HsbQuality => format!("HSB Quality"),
            Self::CieX => format!("CIE X"),
            Self::CieY => format!("CIE Y"),
            Self::CieBrightness => format!("CIE Brightness"),
            Self::ColorRgbRed => format!("RGB Red"),
            Self::ColorRgbGreen => format!("RGB Green"),
            Self::ColorRgbBlue => format!("RGB Blue"),
            Self::ColorRgbCyan => format!("RGB Cyan"),
            Self::ColorRgbMagenta => format!("RGB Magenta"),
            Self::ColorRgbYellow => format!("RGB Yellow"),
            Self::ColorRgbQuality => format!("RGB Quality"),
            Self::VideoBoostR => format!("Video Boost Red"),
            Self::VideoBoostG => format!("Video Boost Green"),
            Self::VideoBoostB => format!("Video Boost Blue"),
            Self::VideoHueShift => format!("Video Hue Shift"),
            Self::VideoSaturation => format!("Video Saturation"),
            Self::VideoBrightness => format!("Video Brightness"),
            Self::VideoContrast => format!("Video Contrast"),
            Self::VideoKeyColorR => format!("Video Key Color Red"),
            Self::VideoKeyColorG => format!("Video Key Color Green"),
            Self::VideoKeyColorB => format!("Video Key Color Blue"),
            Self::VideoKeyIntensity => format!("Video Key Intensity"),
            Self::VideoKeyTolerance => format!("Video Key Tolerance"),

            Self::StrobeDuration => format!("Strobe Duration"),
            Self::StrobeRate => format!("Strobe Rate"),
            Self::StrobeFrequency => format!("Strobe Frequency"),
            Self::StrobeModeShutter => format!("Strobe Mode Shutter"),
            Self::StrobeModeStrobe => format!("Strobe Mode Strobe"),
            Self::StrobeModePulse => format!("Strobe Mode Pulse"),
            Self::StrobeModePulseOpen => format!("Strobe Mode Pulse Open"),
            Self::StrobeModePulseClose => format!("Strobe Mode Pulse Close"),
            Self::StrobeModeRandom => format!("Strobe Mode Random"),
            Self::StrobeModeRandomPulse => format!("Strobe Mode Random Pulse"),
            Self::StrobeModeRandomPulseOpen => format!("Strobe Mode Random Pulse Open"),
            Self::StrobeModeRandomPulseClose => format!("Strobe Mode Random Pulse Close"),
            Self::StrobeModeEffect => format!("Strobe Mode Effect"),
            ...
            Self::Iris => format!("Iris"),
            Self::IrisStrobe => format!("Iris Strobe"),
            Self::IrisStrobeRandom => format!("Iris Strobe Random"),
            Self::IrisPulseClose => format!("Iris Pulse Close"),
            Self::IrisPulseOpen => format!("Iris Pulse Open"),
            Self::IrisRandomPulseClose => format!("Iris Random Pulse Close"),
            Self::IrisRandomPulseOpen => format!("Iris Random Pulse Open"),
            ...
            Self::EffectsSync => format!("Effects Sync"),
            Self::BeamShaper => format!("Beam Shaper"),
            Self::BeamShaperMacro => format!("Beam Shaper Macro"),
            Self::BeamShaperPos => format!("Beam Shaper Position"),
            Self::BeamShaperPosRotate => format!("Beam Shaper Position Rotate"),
            Self::Zoom => format!("Zoom"),
            Self::ZoomModeSpot => format!("Zoom Mode Spot"),
            Self::ZoomModeBeam => format!("Zoom Mode Beam"),
            Self::DigitalZoom => format!("Digital Zoom"),
            ...
            Self::DimmerMode => format!("Dimmer Mode"),
            Self::DimmerCurve => format!("Dimmer Curve"),
            Self::BlackoutMode => format!("Blackout Mode"),
            Self::LedFrequency => format!("LED Frequency"),
            Self::LedZoneMode => format!("LED Zone Mode"),
            Self::PixelMode => format!("Pixel Mode"),
            Self::PanMode => format!("Pan Mode"),
            Self::TiltMode => format!("Tilt Mode"),
            Self::PanTiltMode => format!("Pan Tilt Mode"),
            Self::PositionModes => format!("Position Modes"),
            Self::GoboWheelMode(n) => format!("Gobo {n} Wheel Mode"),
            Self::GoboWheelShortcutMode => format!("Gobo Wheel Shortcut Mode"),
            Self::AnimationWheelMode(n) => format!("Animation {n} Wheel Mode"),
            Self::AnimationWheelShortcutMode => format!("Animation Wheel Shortcut Mode"),
            Self::ColorMode(n) => format!("Color {n} Mode"),
            Self::ColorWheelShortcutMode => format!("Color Wheel Shortcut Mode"),
            Self::CyanMode => format!("Cyan Mode"),
            Self::MagentaMode => format!("Magenta Mode"),
            Self::YellowMode => format!("Yellow Mode"),
            Self::ColorMixMode => format!("Color Mix Mode"),
            Self::ChromaticMode => format!("Chromatic Mode"),
            Self::ColorCalibrationMode => format!("Color Calibration Mode"),
            Self::ColorConsistency => format!("Color Consistency"),
            Self::ColorControl => format!("Color Control"),
            Self::ColorModelMode => format!("Color Model Mode"),
            Self::ColorSettingsReset => format!("Color Settings Reset"),
            Self::ColorUniformity => format!("Color Uniformity"),
            Self::CriMode => format!("CRI Mode"),
            Self::CustomColor => format!("Custom Color"),
            Self::UvStability => format!("UV Stability"),
            Self::WavelengthCorrection => format!("Wavelength Correction"),
            Self::WhiteCount => format!("White Count"),
            Self::StrobeMode => format!("Strobe Mode"),
            Self::ZoomMode => format!("Zoom Mode"),
            Self::FocusMode => format!("Focus Mode"),
            Self::IrisMode => format!("Iris Mode"),
            Self::FanMode(n) => format!("Fan {n} Mode"),
            Self::FollowSpotMode => format!("Follow Spot Mode"),
            Self::BeamEffectIndexRotateMode => format!("Beam Effect Index Rotate Mode"),
            Self::IntensityMSpeed => format!("Intensity MSpeed"),
            Self::PositionMSpeed => format!("Position MSpeed"),
            Self::ColorMixMSpeed => format!("Color Mix MSpeed"),
            Self::ColorWheelSelectMSpeed => format!("Color Wheel Select MSpeed"),
            Self::GoboWheelMSpeed(n) => format!("Gobo {n} Wheel MSpeed"),
            Self::IrisMSpeed => format!("Iris MSpeed"),
            Self::PrismMSpeed(n) => format!("Prism {n} MSpeed"),
            Self::FocusMSpeed => format!("Focus MSpeed"),
            Self::FrostMSpeed(n) => format!("Frost {n} MSpeed"),
            Self::ZoomMSpeed => format!("Zoom MSpeed"),
            Self::FrameMSpeed => format!("Frame MSpeed"),
            Self::GlobalMSpeed => format!("Global MSpeed"),
            Self::ReflectorAdjust => format!("Reflector Adjust"),
            Self::FixtureGlobalReset => format!("Fixture Global Reset"),
            Self::DimmerReset => format!("Dimmer Reset"),
            Self::ShutterReset => format!("Shutter Reset"),
            Self::BeamReset => format!("Beam Reset"),
            Self::ColorMixReset => format!("Color Mix Reset"),
            Self::ColorWheelReset => format!("Color Wheel Reset"),
            Self::FocusReset => format!("Focus Reset"),
            Self::FrameReset => format!("Frame Reset"),
            Self::GoboWheelReset => format!("Gobo Wheel Reset"),
            Self::IntensityReset => format!("Intensity Reset"),
            Self::IrisReset => format!("Iris Reset"),
            Self::PositionReset => format!("Position Reset"),
            Self::PanReset => format!("Pan Reset"),
            Self::TiltReset => format!("Tilt Reset"),
            Self::ZoomReset => format!("Zoom Reset"),
            Self::CtbReset => format!("CTB Reset"),
            Self::CtoReset => format!("CTO Reset"),
            Self::CtcReset => format!("CTC Reset"),
            Self::AnimationSystemReset => format!("Animation System Reset"),
            Self::FixtureCalibrationReset => format!("Fixture Calibration Reset"),
            Self::Function => format!("Function"),
            Self::LampControl => format!("Lamp Control"),
            Self::DisplayIntensity => format!("Display Intensity"),
            Self::DmxInput => format!("DMX Input"),
            Self::NoFeature => format!("No Feature"),
            Self::Blower(n) => format!("Blower {n}"),
            Self::Fan(n) => format!("Fan {n}"),
            Self::Fog(n) => format!("Fog {n}"),
            Self::Haze(n) => format!("Haze {n}"),
            Self::LampPowerMode => format!("Lamp Power Mode"),
            Self::Fans => format!("Fans"),

            Self::BladeA(n) => format!("Blade {n} A"),
            Self::BladeB(n) => format!("Blade {n} B"),
            Self::BladeRot(n) => format!("Blade {n} Rotation"),
            Self::ShaperRot => format!("Shaper Rotation"),
            Self::ShaperMacros => format!("Shaper Macros"),
            Self::ShaperMacrosSpeed => format!("Shaper Macros Speed"),
            ...
            Self::VideoBlendMode => format!("Video Blend Mode"),
            Self::InputSource => format!("Input Source"),
            Self::FieldOfView => format!("Field of View"),
...
impl FromStr for AttributeValue {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        Ok(Self::new(s.parse().wrap_err("failed to parse attribute value")?))
    }
}
