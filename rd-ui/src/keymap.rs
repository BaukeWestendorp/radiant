...
impl Default for Keymap {
    fn default() -> Self {
        Self::new(vec![
            KeymapBinding::new("app::Quit", "secondary-q", "Root"),
            ...
            KeymapBinding::new("root::SelectionClear", "escape", "Root"),
            KeymapBinding::new("root::SelectionAll", "secondary-a", "Root"),

            KeymapBinding::new("popup::Dismiss", "escape", "Popup"),
            ...
            KeymapBinding::new("picker::Next", "right", "Picker"),
            KeymapBinding::new("picker::Next", "down", "Picker"),
            KeymapBinding::new("picker::Previous", "left", "Picker"),
            KeymapBinding::new("picker::Previous", "up", "Picker"),
            KeymapBinding::new("picker::Clear", "escape", "Picker"),

            KeymapBinding::new("table::PrevRow", "up", "Table"),
            KeymapBinding::new("table::NextRow", "down", "Table"),
            KeymapBinding::new("table::ExtendSelectionPrev", "shift-up", "Table"),
            KeymapBinding::new("table::ExtendSelectionNext", "shift-down", "Table"),
            KeymapBinding::new("table::PrevColumn", "left", "Table"),
            KeymapBinding::new("table::NextColumn", "right", "Table"),

            KeymapBinding::new("tabs::Next", "right", "Tabs"),
            KeymapBinding::new("tabs::Next", "down", "Tabs"),
            KeymapBinding::new("tabs::Previous", "left", "Tabs"),
            KeymapBinding::new("tabs::Previous", "up", "Tabs"),
        ])
    }
}
