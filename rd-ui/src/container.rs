...
impl ContainerStyle {
    pub fn normal(window: &Window, cx: &App) -> Self {
        Self {
            background: cx.theme().bg_secondary,
            border: cx.theme().border_secondary,
    ...
    pub fn focused(window: &Window, cx: &App) -> Self {
        Self {
            background: cx.theme().bg_focus,
            border: cx.theme().border_focus,
            text_color: window.text_style().color,
        }
    }
    ...
    pub fn selected(window: &Window, cx: &App) -> Self {
        Self {
            background: cx.theme().bg_selected,
    ...
    pub fn hovered(&self) -> Self {
        Self {
            ...
            border: self.border.hover(),
            text_color: self.text_color.hover(),
        }
    }
