...
///
/// ```
/// # use rd_dmx::{Address, UniverseId, Channel};
...
impl UniverseId {
    ...
    ///
    /// ```
    /// let valid_universe = rd_dmx::UniverseId::new(1);
    /// assert!(valid_universe.is_ok());
    ///
    /// let invalid = rd_dmx::UniverseId::new(0);
    /// assert!(invalid.is_err());
    /// ```
...
impl Universe {
    ...
    ///
    /// ```
    /// let universe = rd_dmx::Universe::new();
    /// ```
    pub fn new() -> Self {
    ...
    /// ```
    /// let universe = rd_dmx::Universe::new();
    /// let channel = rd_dmx::Channel::new(1).unwrap();
    /// assert_eq!(universe.value(&channel), rd_dmx::Value(0));
    /// ```
    ...
    ///
    /// ```
    /// let mut universe = rd_dmx::Universe::new();
    ///
    /// let channel = rd_dmx::Channel::new(1).unwrap();
    /// universe.set_value(&channel, rd_dmx::Value(128));
    /// assert_eq!(universe.value(&channel), rd_dmx::Value(128));
    /// ```
...
///
/// ```
/// let mut multiverse = rd_dmx::Multiverse::new();
///
/// // Add a universe
/// let id = rd_dmx::UniverseId::new(1).unwrap();
/// let universe = rd_dmx::Universe::new();
...
impl Multiverse {
    ...
    /// ```
    /// let mut multiverse = rd_dmx::Multiverse::new();
    /// multiverse.create_universe(rd_dmx::UniverseId::new(1).unwrap(), rd_dmx::Universe::new());
    /// ```
    ...
    /// let mut multiverse = rd_dmx::Multiverse::new();
    /// let id = rd_dmx::UniverseId::new(1).unwrap();
    /// multiverse.create_universe(id, rd_dmx::Universe::new());
    ///
    ...
    /// let mut multiverse = rd_dmx::Multiverse::new();
    /// multiverse.create_universe(rd_dmx::UniverseId::new(1).unwrap(), rd_dmx::Universe::new());
    /// multiverse.create_universe(rd_dmx::UniverseId::new(2).unwrap(), rd_dmx::Universe::new());
    ///
    /// multiverse.clear();
    ///
    /// for (_, universe) in multiverse.universes() {
    ///     assert!(universe.values().iter().all(|&value| value == rd_dmx::Value(0)));
    /// }
    /// ```
    pub fn clear(&mut self) {
    ...
    /// multiverse.create_universe(id, rd_dmx::Universe::new());
    ///
    /// let address = rd_dmx::Address::new(id, rd_dmx::Channel::new(1).unwrap());
    /// multiverse.set_value(&address, rd_dmx::Value(128));
    /// ```
    ...
    /// multiverse.set_value(&address, rd_dmx::Value(128));
    ///
    /// assert_eq!(multiverse.value(&address), Some(rd_dmx::Value(128)));
    /// ```
