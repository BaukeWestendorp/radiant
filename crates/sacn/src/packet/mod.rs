...
pub(crate) const _VECTOR_EXTENDED_SYNCHRONIZATION: u32 = 0x00000001;
pub(crate) const _VECTOR_EXTENDED_DISCOVERY: u32 = 0x00000002;
pub(crate) const _VECTOR_UNIVERSE_DISCOVERY_UNIVERSE_LIST: u32 = 0x00000001;
pub(crate) const _UNIVERSE_DISCOVERY_INTERVAL: Duration = Duration::from_secs(10);
pub(crate) const _NETWORK_DATA_LOSS_TIMEOUT: Duration = Duration::from_millis(2500);
pub(crate) const _DISCOVERY_UNIVERSE: u32 = 64214;
