    ...
    Def::Control: VisualControl<Def>,
{
    ...
    fn node<'cx>(&'cx self, cx: &'cx App) -> &Node<Def> {
    ...
    fn handle_drag_move(&mut self, event: &DragMoveEvent<NodeDrag>, cx: &mut Context<Self>) {
    ...
    fn handle_mouse_up(&mut self, _: &MouseUpEvent, cx: &mut Context<Self>) {
