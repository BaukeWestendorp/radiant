...
This project is inspired by the [GrandMA2/3](https://www.malighting.com/grandma3/) lighting consoles, but has a new vision for generating effects. _When we actually get to generating effects_ we want to experiment with a node editor based effect generator.
